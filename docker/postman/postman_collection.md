...
- [cookbook examples](#cookbook-examples)
  - [`GET`] [Latest lidvid for a given lid (no suffix))](#get-latest-lidvid-for-a-given-lid-no-suffix)
  - [`GET`] [Latest lidvid for a given lid (latest suffix)](#get-latest-lidvid-for-a-given-lid-latest-suffix)
  - [`GET`] [All lidvid for a given lid (all suffix)](#get-all-lidvid-for-a-given-lid-all-suffix)
  - [`GET`] [Search by processing level](#get-search-by-processing-level)
  - [`GET`] [Search by target](#get-search-by-target)
  - [`GET`] [Search by reference](#get-search-by-reference)
  - [`GET`] [search for collection of an observtional product, kvp response](#get-search-for-collection-of-an-observtional-product-kvp-response)
  - [`GET`] [Search for a product knowing its DOI](#get-search-for-a-product-knowing-its-doi)
- [requirements](#requirements)
  - [`GET`] [NASA-PDS/registry-api#494 querystring supports EQ](#get-nasa-pdsregistry-api494-querystring-supports-eq)
  - [`GET`] [NASA-PDS/registry-api#494 querystring supports NE](#get-nasa-pdsregistry-api494-querystring-supports-ne)
  - [`GET`] [NASA-PDS/registry-api#494 querystring supports GT](#get-nasa-pdsregistry-api494-querystring-supports-gt)
  - [`GET`] [NASA-PDS/registry-api#494 querystring supports LT](#get-nasa-pdsregistry-api494-querystring-supports-lt)
  - [`GET`] [NASA-PDS/registry-api#494 querystring supports GE](#get-nasa-pdsregistry-api494-querystring-supports-ge)
  - [`GET`] [NASA-PDS/registry-api#494 querystring supports LE](#get-nasa-pdsregistry-api494-querystring-supports-le)
  - [`GET`] [NASA-PDS/registry-api#495 querystring supports AND](#get-nasa-pdsregistry-api495-querystring-supports-and)
  - [`GET`] [NASA-PDS/registry-api#495 querystring supports OR](#get-nasa-pdsregistry-api495-querystring-supports-or)
  - [`GET`] [NASA-PDS/registry-api#495 querystring supports NOT](#get-nasa-pdsregistry-api495-querystring-supports-not)
  - [`GET`] [NASA-PDS/registry-api#493 querystring supports NOT on other endpoint](#get-nasa-pdsregistry-api493-querystring-supports-not-on-other-endpoint)
  - [`GET`] [NASA-PDS/registry-api#495 querystring supports lowercase operators](#get-nasa-pdsregistry-api495-querystring-supports-lowercase-operators)
  - [`GET`] [NASA-PDS/pds-api#72 search by a temporal range as an ISO-8601 time interval](#get-nasa-pdspds-api72-search-by-a-temporal-range-as-an-iso-8601-time-interval)
  - [`GET`] [NASA-PDS/pds-api#99 free text search](#get-nasa-pdspds-api99-free-text-search)
  - [`GET`] [NASA-PDS/registry-api#80 select fields in response for lid/lidvid resolution](#get-nasa-pdsregistry-api80-select-fields-in-response-for-lidlidvid-resolution)
  - [`GET`] [NASA-PDS/registry#153 all properties are searchable](#get-nasa-pdsregistry153-all-properties-are-searchable)
  - [`GET`] [NASA-PDS/registry-api#349 Request for json+pds4 response fails in production](#get-nasa-pdsregistry-api349-request-for-jsonpds4-response-fails-in-production)
  - [`GET`] [NASA-PDS/registry-api#336 As a PDS operator, I want to know the health of the registry API service](#get-nasa-pdsregistry-api336-as-a-pds-operator-i-want-to-know-the-health-of-the-registry-api-service)
  - [`GET`] [NASA-PDS/registry-api/352 pagination step 1](#get-nasa-pdsregistry-api352-pagination-step-1)
  - [`GET`] [NASA-PDS/registry-api/352 pagination step 2](#get-nasa-pdsregistry-api352-pagination-step-2)
  - [`GET`] [NASA-PDS/registry-api/352 members pagination step 1](#get-nasa-pdsregistry-api352-members-pagination-step-1)
  - [`GET`] [NASA-PDS/registry-api/352 members pagination step 2](#get-nasa-pdsregistry-api352-members-pagination-step-2)
  - [`GET`] [NASA-PDS/registry-api#434 get product from lidvid](#get-nasa-pdsregistry-api434-get-product-from-lidvid)
  - [`GET`] [NASA-PDS/registry-api#434 get product from lidvid not supported Accept](#get-nasa-pdsregistry-api434-get-product-from-lidvid-not-supported-accept)
  - [`GET`] [NASA-PDS/registry-api#434 get product from lidvid missing](#get-nasa-pdsregistry-api434-get-product-from-lidvid-missing)
  - [`GET`] [NASA-PDS/registry-api#435 get latest product from lid](#get-nasa-pdsregistry-api435-get-latest-product-from-lid)
  - [`GET`] [NASA-PDS/registry-api#435 get latest product from lid with explicit latest](#get-nasa-pdsregistry-api435-get-latest-product-from-lid-with-explicit-latest)
  - [`GET`] [NASA-PDS/registry-api#436 get all product for a given lid](#get-nasa-pdsregistry-api436-get-all-product-for-a-given-lid)
  - [`GET`] [NASA-PDS/registry-api#436 get all product for a given lid with pagination, page 1](#get-nasa-pdsregistry-api436-get-all-product-for-a-given-lid-with-pagination-page-1)
  - [`GET`] [NASA-PDS/registry-api#436 get all product for a given lid with pagination, page 2](#get-nasa-pdsregistry-api436-get-all-product-for-a-given-lid-with-pagination-page-2)
  - [`GET`] [NASA-PDS/registry-api#436 get all product for a given lid with pagination, page 2 missing sort](#get-nasa-pdsregistry-api436-get-all-product-for-a-given-lid-with-pagination-page-2-missing-sort)
  - [`GET`] [NASA-PDS/registry-api#469 q param simple criteria](#get-nasa-pdsregistry-api469-q-param-simple-criteria)
  - [`GET`] [NASA-PDS/registry-api/issues/66 invalid q string](#get-nasa-pdsregistry-apiissues66-invalid-q-string)
  - [`GET`] [NASA-PDS/registry-api#457 q param like operator with wildcard](#get-nasa-pdsregistry-api457-q-param-like-operator-with-wildcard)
  - [`GET`] [NASA-PDS/registry-api#469 q param criteria combination](#get-nasa-pdsregistry-api469-q-param-criteria-combination)
  - [`GET`] [NASA-PDS/registry-api#223 products/{id}/members](#get-nasa-pdsregistry-api223-productsidmembers)
  - [`GET`] [NASA-PDS/registry-api#484 products/{id}/members default to latest-only](#get-nasa-pdsregistry-api484-productsidmembers-default-to-latest-only)
  - [`GET`] [NASA-PDS/registry-api#453 products/{id}/members/members](#get-nasa-pdsregistry-api453-productsidmembersmembers)
  - [`GET`] [NASA-PDS/registry-api#485 products/{id}/members/members default to latest-only](#get-nasa-pdsregistry-api485-productsidmembersmembers-default-to-latest-only)
  - [`GET`] [NASA-PDS/registry-api#451/452 products/{id}/member-of](#get-nasa-pdsregistry-api451452-productsidmember-of)
  - [`GET`] [NASA-PDS/registry-api#451/486 products/{id}/member-of default to latest-only](#get-nasa-pdsregistry-api451486-productsidmember-of-default-to-latest-only)
  - [`GET`] [NASA-PDS/registry-api#454 products/{id}/member-of/member-of](#get-nasa-pdsregistry-api454-productsidmember-ofmember-of)
  - [`GET`] [NASA-PDS/registry-api#487 products/{id}/member-of/member-of default to latest-only](#get-nasa-pdsregistry-api487-productsidmember-ofmember-of-default-to-latest-only)
  - [`GET`] [NASA-PDS/registry-api#497 application/json multi product result does not contain blobs](#get-nasa-pdsregistry-api497-applicationjson-multi-product-result-does-not-contain-blobs)
  - [`GET`] [NASA-PDS/registry-api#497 application/json single product result does not contain blobs](#get-nasa-pdsregistry-api497-applicationjson-single-product-result-does-not-contain-blobs)
  - [`GET`] [NASA-PDS/registry-api#497 application/kvp+json multi-product result does not contain blobs](#get-nasa-pdsregistry-api497-applicationkvpjson-multi-product-result-does-not-contain-blobs)
  - [`GET`] [NASA-PDS/registry-api#497 application/kvp+json single product result does not contain blobs](#get-nasa-pdsregistry-api497-applicationkvpjson-single-product-result-does-not-contain-blobs)
  - [`GET`] [NASA-PDS/registry-api#497 application/xml single product result does not contain blobs](#get-nasa-pdsregistry-api497-applicationxml-single-product-result-does-not-contain-blobs)
  - [`GET`] [NASA-PDS/registry-api#497 application/xml multi-product result does not contain blobs](#get-nasa-pdsregistry-api497-applicationxml-multi-product-result-does-not-contain-blobs)
  - [`GET`] [NASA-PDS/registry-api#516 Welcome page](#get-nasa-pdsregistry-api516-welcome-page)
  - [`GET`] [NASA-PDS/registry-api#439 I get application/json results from my browser](#get-nasa-pdsregistry-api439-i-get-applicationjson-results-from-my-browser)
  - [`GET`] [NASA-PDS/registry-api#440 get pds4+xml results on multiple products responses](#get-nasa-pdsregistry-api440-get-pds4xml-results-on-multiple-products-responses)
  - [`GET`] [NASA-PDS/registry-api#440 get pds4+xml results on single product responses](#get-nasa-pdsregistry-api440-get-pds4xml-results-on-single-product-responses)
  - [`GET`] [NASA-PDS/registry-api#450 get pds4+json results on multiple products responses](#get-nasa-pdsregistry-api450-get-pds4json-results-on-multiple-products-responses)
  - [`GET`] [NASA-PDS/registry-api#440 get pds4+json results on single product responses](#get-nasa-pdsregistry-api440-get-pds4json-results-on-single-product-responses)
  - [`GET`] [NASA-PDS/registry-api#459 return requested fields only text/csv](#get-nasa-pdsregistry-api459-return-requested-fields-only-textcsv)
  - [`GET`] [NASA-PDS/registry-api#459 return requested fields only application/kvp+json](#get-nasa-pdsregistry-api459-return-requested-fields-only-applicationkvpjson)
  - [`GET`] [NASA-PDS/registry-api#459 return requested fields only application/json](#get-nasa-pdsregistry-api459-return-requested-fields-only-applicationjson)
  - [`GET`] [NASA-PDS/registry-api#283 facets on terms](#get-nasa-pdsregistry-api283-facets-on-terms)
  - [`GET`] [NASA-PDS/registry-api#406 search on existent field](#get-nasa-pdsregistry-api406-search-on-existent-field)
  - [`GET`] [NASA-PDS/registry-api#406 search on existent wildcard field](#get-nasa-pdsregistry-api406-search-on-existent-wildcard-field)
  - [`GET`] [NASA-PDS/registry-api#406 search on non-existent field](#get-nasa-pdsregistry-api406-search-on-non-existent-field)
  - [`GET`] [NASA-PDS/registry-api#406 search on non-existent wildcard field](#get-nasa-pdsregistry-api406-search-on-non-existent-wildcard-field)
  - [`GET`] [NASA-PDS/registry-api#406 search on NOT non-existent field](#get-nasa-pdsregistry-api406-search-on-not-non-existent-field)
  - [`GET`] [NASA-PDS/registry-api#406 search on NOT non-existent wildcard field](#get-nasa-pdsregistry-api406-search-on-not-non-existent-wildcard-field)
  - [`GET`] [NASA-PDS/registry-api#406 search on NOT existent field](#get-nasa-pdsregistry-api406-search-on-not-existent-field)
  - [`GET`] [NASA-PDS/registry-api#406 search on NOT existent wildcard field](#get-nasa-pdsregistry-api406-search-on-not-existent-wildcard-field)
- [other tickets](#other-tickets)
  - [`GET`] [NASA-PDS/registry-api#277 /properties endpoint](#get-nasa-pdsregistry-api277-properties-endpoint)
  - [`GET`] [NASA-PDS/registry-api#326 list product classes](#get-nasa-pdsregistry-api326-list-product-classes)
  - [`GET`] [NASA-PDS/registry-api#375 csv response, use | as inner list separator](#get-nasa-pdsregistry-api375-csv-response-use-as-inner-list-separator)
  - [`GET`] [NASA-PDS/registry-api#296 API crashes with JVM memory error on data sets with very large labels (>1MB)](#get-nasa-pdsregistry-api296-api-crashes-with-jvm-memory-error-on-data-sets-with-very-large-labels-1mb)
  - [`GET`] [NASA-PDS/registry-api#356 Accept:* response not defaulting to valid application/json](#get-nasa-pdsregistry-api356-accept-response-not-defaulting-to-valid-applicationjson)
  - [`GET`] [NASA-PDS/registry-api#262 the request url in the error message does not make sense](#get-nasa-pdsregistry-api262-the-request-url-in-the-error-message-does-not-make-sense)
  - [`GET`] [NASA-PDS/registry-api#341 members of a bundle does not work on new test dataset](#get-nasa-pdsregistry-api341-members-of-a-bundle-does-not-work-on-new-test-dataset)
